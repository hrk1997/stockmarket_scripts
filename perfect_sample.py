...
browser.get('https://www1.nseindia.com/live_market/dynaContent/live_watch/get_quote/GetQuote.jsp?symbol=WIPRO&illiquid=0&smeFlag=0&itpFlag=0')
...
#browser.get('https://www1.nseindia.com/live_market/dynaContent/live_watch/get_quote/GetQuote.jsp?symbol=VGUARD&illiquid=0&smeFlag=0&itpFlag=0')
#s_ = browser.find_element_by_css_selector('')
#s_ = browser.find_element_by_css_selector('')
#LastUpdatedDiv     date
#companyName        name
#lastPrice
