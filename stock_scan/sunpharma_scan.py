...
browser.get('https://www1.nseindia.com/live_market/dynaContent/live_watch/get_quote/GetQuote.jsp?symbol=SUNPHARMA&illiquid=0&smeFlag=0&itpFlag=0')
set1 = browser.find_element_by_css_selector('#companies > ul')
set2 = browser.find_element_by_css_selector('#fundamentals_tbl')
data = browser.find_element_by_css_selector('#companies > table > tbody > tr > td:nth-child(3)')
data1 = browser.find_element_by_css_selector('#companies > div.bank_info > div.left_info > p.title')
